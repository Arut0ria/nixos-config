...
{
  flake.wrapperModules.noctalia-config = moduleWithSystem (
    perSystem@{ self', ... }:
    nixos@{
      config,
      lib,
      ...
      config = {
        ...
        settings = {
              ...
              left = [
                {
                  ...
                  # customIconPath = "/home/theo/Téléchargements/NixOS.svg";
          ...
          general = {
            ...
            animationSpeed = 1;
            autoStartAuth = false;
            avatarImage = "${res}/share/sddm_icon.png";
            boxRadiusRatio = 1;
          ...
          ui = {
            ...
            fontDefault = config.defaultFont;
            fontDefaultScale = 1;
            fontFixed = config.monoFont;
            fontFixedScale = 1;
        ...
        #   };
        #   # wallpapers = {
        #   #   DP-2 = "/home/theo/Pictures/Wallpapers/wallhaven_0pe1z3.jpg";
        #   #   HDMI-A-2 = "/home/theo/Pictures/Wallpapers/wallhaven_0pe1z3.jpg";
        #   # };
        # };
      };
    }
